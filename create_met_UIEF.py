...
mylon = 271.80389  # site longitude (0 to 360)
mylat = 40.06278  # site latitude
measurement_height = 5  # tower height for wind (m)
filename = os.path.join(os.environ['PROJDIR'], 'ERW_LDRD', 'results', 'UIEF_metdata.csv')
...
invars = ["AirTC_Avg", "RH1_Avg", "WindSpd_Avg", "PRESSURE_Avg", "SRDS", "FLDS", "RAIN_Tot"]

conv_add = [273.15, 0, 0, 0, 0, 0, 0, 0]
conv_mult = [1, 1, 1, 100, 1, 1, 1 / 3600] # milibars => Pa,  mm/h -> kg/m-2/s
